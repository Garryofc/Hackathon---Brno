import "./chunk-2UH3ONK5.js";
import "./chunk-NYBPLUIO.js";
import "./chunk-5ALXL3JH.js";
import {
  derived,
  get as get2,
  writable
} from "./chunk-G4MJWCVW.js";
import {
  add_locations,
  check_target,
  hmr,
  ...
  store_get,
  validate_store
} from "./chunk-VIVCXST2.js";
import {
  append,
  comment,
  head,
  template
} from "./chunk-FPCXLHSU.js";
import {
  FILENAME,
  HMR,
  deep_read_state,
...
var root_2 = add_locations(template(`<meta name="theme-color">`), Mode_watcher[FILENAME], [[69, 2]]);
  ...
  head(($$anchor2) => {
    ...
    if_block(
      ...
      ($$anchor3) => {
        ...
        html(node_2, () => `<script nonce=${get(trueNonce)}>(` + setInitialMode.toString() + `)(` + JSON.stringify(initConfig) + `);<\/script>`, false, false);
        append($$anchor3, fragment_1);
      },
      ($$anchor3) => {
        var fragment_2 = comment();
        var node_3 = first_child(fragment_2);
        html(node_3, () => `<script>(` + setInitialMode.toString() + `)(` + JSON.stringify(initConfig) + `);<\/script>`, false, false);
